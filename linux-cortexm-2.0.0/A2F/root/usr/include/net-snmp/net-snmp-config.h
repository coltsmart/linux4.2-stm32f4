...
#define NETSNMP_CONFIGURE_OPTIONS " '--host=arm-uclinux' '--build=i386-linux' '--with-cc=arm-uclinuxeabi-gcc' '--disable-debugging' '--enable-mini-agent' '--with-transports=UDP' '--disable-mib-loading' '--disable-manuals' '--disable-scripts' '--disable-mibs' '--with-security-modules=' '--disable-des' '--disable-privacy' '--disable-md5' '--with-out-transports=TCP TCPBase' '--with-default-snmp-version=2' '--with-sys-contact=admin@no.where' '--with-sys-location=Unknown' '--prefix=/work/psl/SF/release/cm-2.0.0/linux-cortexm-2.0.0/A2F/root/usr' '--with-logfile=/var/log/snmpd.log' '--with-persistent-directory=/var/lib/snmp' 'build_alias=i386-linux' 'host_alias=arm-uclinux' 'CFLAGS=-Os -mcpu=cortex-m3 -mthumb -I/work/psl/SF/release/cm-2.0.0/linux-cortexm-2.0.0/A2F/root/usr/include' 'LDFLAGS=-mcpu=cortex-m3 -mthumb -L/work/psl/SF/release/cm-2.0.0/linux-cortexm-2.0.0/A2F/root/usr/lib'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/work/psl/SF/release/cm-2.0.0/linux-cortexm-2.0.0/A2F/root/usr/share/snmp/mibs"
...
#define SNMPLIBPATH "/work/psl/SF/release/cm-2.0.0/linux-cortexm-2.0.0/A2F/root/usr/lib/snmp"
#define SNMPSHAREPATH "/work/psl/SF/release/cm-2.0.0/linux-cortexm-2.0.0/A2F/root/usr/share/snmp"
#define SNMPCONFPATH "/work/psl/SF/release/cm-2.0.0/linux-cortexm-2.0.0/A2F/root/usr/etc/snmp"
#define SNMPDLMODPATH "/work/psl/SF/release/cm-2.0.0/linux-cortexm-2.0.0/A2F/root/usr/lib/snmp/dlmod"
